...
public class ManufactureOntology extends Ontology {
    ...
    private ManufactureOntology() {
        ...
        try {
            ...
            orderSchema.add("id", (TermSchema) getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
            ...
            itemSchema.add("id", (TermSchema) getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
            ...
            resourceSchema.add("id", (TermSchema) getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
