package org.manufacture.constants;

public class Constants {

    /**
     * ConversationID - уникальные идентификаторы переговоров
     **/
     ...
     * Agents types
     **/
    public static final String PRODUCT_MANAGER_TYPE = "product-manager";
    public static final String PRODUCT_MANUFACTURER_TYPE = "product-manufacturer";
